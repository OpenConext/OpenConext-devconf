Feature: Use case A: Institutions with few (10-20) users using a third party vetting service
  ...
  Scenario: Setup of the institution configuration and test users
     Given I have the payload
      ...
      And a user "Usain Sergei" identified by "urn:collab:person:dev.openconext.local:joe--ra" from institution "dev.openconext.local"
      And the user "urn:collab:person:dev.openconext.local:joe--ra" has a vetted "yubikey" with identifier "00000004"
